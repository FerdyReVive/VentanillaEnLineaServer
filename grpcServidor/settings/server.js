...
const subirArchivo = require('../controllers/tramitesgrpcController').subirArchivo;
const descargarArchivo = require('../controllers/tramitesgrpcController').descargarArchivo;
...
class servidorgrpc{
    ...
    getServer(){
        ...
        server.addService(this.tramitespackage.filemanagement.service, {subirArchivo, descargarArchivo});
        return server;
    }
}
